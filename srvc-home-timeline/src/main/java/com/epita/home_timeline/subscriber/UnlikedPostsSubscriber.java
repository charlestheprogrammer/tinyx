...
import com.epita.home_timeline.controller.dto.LikeDTO;
...
public class UnlikedPostsSubscriber implements Consumer<LikeDTO> {
    ...
    public UnlikedPostsSubscriber(final RedisDataSource ds, final SocialService socialService, final TimelineService timelineService) {
